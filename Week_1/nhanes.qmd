...
prior_probability_that_someone_has_diabetes <-df %>% 
  tabyl(DIQ010) %>% 
  adorn_totals("row")
prior_probability_that_someone_has_diabetes
```
...
prior_probability_that_someone_that_eats_ahi <- df %>% 
  tabyl(DRD370B) %>% 
  adorn_totals("row")
prior_probability_that_someone_that_eats_ahi
```
...
```{r}
(prior_probability_that_someone_that_eats_ahi*likelihood)/prior_probability_that_someone_has_diabetes
```
