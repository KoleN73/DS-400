...
```{r}
ggplot(data = bikes, aes(x = date, y = rides, color = season, shape = weekend)) +
  geom_point()
```
...
ggplot(data = bikes, aes(x = temp_feel, y = rides)) +
  geom_point() +
  geom_smooth(method = "lm") + # gives line of best fit
  stat_cor() #gives statistical information
```
